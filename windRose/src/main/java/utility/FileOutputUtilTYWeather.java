...
public class FileOutputUtilTYWeather {
	 ...
	 * @throws IOException
	 */
	public PolarChart txtOutput(Station station,String startDate, String endDate,double[][] windRoses, String stno, Boolean runPerMonth) throws ParseException, IOException{
		...
		String subFilename = "WR_A_" + startDate.substring(0,10) + "_" + endDate.substring(0,10) + "_" + stno;
	    ...
	    WindRoseChartTYWeather rose = new WindRoseChartTYWeather();
	    PolarChart chart = rose.createRoseTYWeather(windRoses[0][1], data0, data1, data2, angles, stno, stnCName, stnEName, startDate, endDate, runPerMonth);	   
