...
public class FileOutputUtilYear {
	...
	public PolarChart txtOutput(Station station,String startDate, String endDate,double[][] windRoses, String stno, Boolean runPerMonth, int month) throws ParseException, IOException{
	    ...
	    WindRoseChartYear rose = new WindRoseChartYear();
	    PolarChart chart = rose.createRoseYear(windRoses[0][1], data0, data1, data2, angles, stno, stnCName, stnEName, startDate, endDate, runPerMonth, month);	   
